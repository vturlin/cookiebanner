...
center_creat.insertAdjacentHTML('afterbegin','
...
Cookies strictement nécessaires : Ces cookies sont absolument nécessaires au bon fonctionnement de notre site et ne peuvent être désactivés.
Cookies de mesure de la performance: Ces cookies nous permettent de mesurer l\'activité des utilisateurs sur notre site. Ils nous sont importants pour vous proposer une naviagation et du contenu adaptés.
Cookies de fonctionnalité: Ces cookies nous permettent de mettre en oeuvre des fonctionnalités de personnalisation de votre expérience sur notre site
Cookies de publicité ciblée: Ces cookies peuvent être déposés par nos partenaires publicitaires afin de vous proposer des publicités sur des contenus pertinents et qui vous intéressent.
SAUVEGARDER MA SELECTION
')
...
Mon Nouveau mètre carré utilise des cookies pour personnaliser le contenu et vous offrir une expérience sur mesure. Vous pouvez gérer vos préférences et en savoir plus en cliquant sur "Paramètres des cookies" et à tout moment dans notre Politique de confidentialité. <+policies+>
ACCEPTER
...
var consent_cat = [1]
for(var i=1 ; i var check_mode = check_box[i].getAttribute('check_mode')
