...
center_creat.insertAdjacentHTML('afterbegin','<div id="preference_center"style="padding:2%;display:none;"><div class="cmpwrapper_1"> <div class="cmplogo" id="logo_pref_center"><img style="width:80px;height:60px;" src='+dl_logo+'> </div> <span class="cmptitle" id="title_pref_center">Centre de préférences</span></div><span class="cmpdescription_center">Lorsque vous consultez un site Web, des données peuvent être stockées dans votre navigateur ou récupérées à partir de celui-ci, généralement sous la forme de cookies. Ces informations peuvent porter sur vous, sur vos préférences ou sur votre appareil et sont principalement utilisées pour s\'assurer que le site Web fonctionne correctement. Les informations ne permettent généralement pas de vous identifier directement, mais peuvent vous permettre de bénéficier d\'une expérience Web personnalisée. Parce que nous respectons votre droit à la vie privée, nous vous donnons la possibilité de ne pas autoriser certains types de cookies. Cliquez sur les différentes catégories pour obtenir plus de détails sur chacune d\'entre elles, et modifier les paramètres par défaut. Toutefois, si vous bloquez certains types de cookies, votre expérience de navigation et les services que nous sommes en mesure de vous offrir peuvent être impactés.</span><div class="cmpcategory" id="category" style="overflow:hidden;overflow-y:scroll;max-height:300px;"> <div class="cmpcategory_1" id="category_1"> <span class="cmpcat_title">Cookies strictement nÃ©cessaires :</span> <span class="cmpcat_description">Ces cookies sont absolument necessaires au bon fonctionnement de notre site et ne peuvent Ãªtre dÃ©sactivÃ©s.</span> <div class="toggle_validation" id="toggle_validation"><label class="switch"><input type="checkbox"id="check_1" check_mode="checked" disabled="disabled" checked onclick="pop(this)"><span class="slider round"></span></label></div> </div> <div class="cmpcategory_2" id="category_2" > <span class="cmpcat_title">Cookies de mesure de la performance:</span> <span class="cmpcat_description">Ces cookies nous permettent de mesurer l\'activitÃ© des utilisateurs sur notre site. Ils nous sont importants pour vous proposer une naviagation et du contenu adaptÃ©s.</span> <div class="toggle_validation" id="toggle_validation"><label class="switch"><input type="checkbox" id="check_2"check_mode="none"onclick="pop(this)"><span class="slider round"></span> </label></div>  </div> <div class="cmpcategory_2" id="category_3"> <span class="cmpcat_title">Cookies de fonctionnalitÃ©:</span> <span class="cmpcat_description">Ces cookies nous permettent de mettre en oeuvre des fonctionnalitÃ©s de personnalisation de votre expÃ©rience sur notre site</span> <div class="toggle_validation" id="toggle_validation"><label class="switch"><input type="checkbox"id="check_3"check_mode="none"onclick="pop(this)"><span class="slider round"></span></label></div> </div> <div class="cmpcategory_2" id="category_4"> <span class="cmpcat_title">Cookies de publicitÃ© ciblÃ©e:</span> <span class="cmpcat_description">Ces cookies peuvent Ãªtre dÃ©posÃ©s par nos partenaires publicitaires afin de vous proposer des publicitÃ©s sur des contenus pertinents et qui vous intÃ©ressent.</span> <div class="toggle_validation" id="toggle_validation"><label class="switch"><input type="checkbox"id="check_4"check_mode="none"onclick="pop(this)"> <span class="slider round"> </span> </label></div> </div> </div> <div> <div class="cmpbutton1" type="button" id="save_choice">SAUVEGARDER MA SELECTION</div> </div> </div> ')
 
var message_creat = document.getElementById('containerauto')
message_creat.insertAdjacentHTML('beforeend','<div id="message"style="padding:2%;display:block;" ><div class="cmpwrapper_1" id="title" style="display:grid;grid-template-columns:auto auto auto;grid-auto-rows:minmax(20px,auto);align-items:center;"> <div class="cmplogo" style="grid-column:1/3;grid-row:1;"><img style="width:80px;height:40px;" src='+dl_logo+'></div> <span class="cmptitle" style= "grid-column:2/3;grid-row:1;">Nous respectons votre vie privée</span> <div id="denied" type="button" class="cmpbutton3">continuer sans accepter</div> </div> <span class="cmpdescription">Mon Nouveau mètre carré utilise des cookies pour personnaliser le contenu et vous offrir une expérience sur mesure. Vous pouvez gérer vos préférences et en savoir plus en cliquant sur "Paramètres des cookies" et à tout moment dans notre <a href='+dl_policies+' class="cmplink">Politique de confidentialité.</a></sp><div id="wrapper"style="display:grid;grid-template-columns:repeat(3,1fr);grid-gap:30px;grid-auto-rows:minmax(30px,auto);align-items:center;"> <div class="cmpbutton2" id="accept"type="button">ACCEPTER</div>	<div class="cmpfavoritestyled2" id="parameter"onclick="redirect(this)"type="button">PERSONNALISER MES CHOIX</div> </div> </div></div>')
